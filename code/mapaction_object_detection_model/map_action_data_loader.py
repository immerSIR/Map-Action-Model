...
test_dataset = Subset(map_action_dataset, indices[7:])

def collate_fn(batch):
    return tuple(*batch)


map_action_data_loader = torch.utils.data.DataLoader(
    dataset,
    batch_size=2,
    shuffle=True,
...
map_action_test_data_loader = torch.utils.data.DataLoader(
    test_dataset,
    batch_size=1,
    shuffle=False,
    num_workers=NUM_WORKERS,
